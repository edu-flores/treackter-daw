...
function Soundboard() {
  ...
  return (
    <div className="flex items-center h-96 bg-secondary">
      {/* Keyboard Icon */}
      <div className="w-16">
        <svg className="fill-white w-[28px] ml-auto" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512">
      ...
      {/* Effects */}
      <div className="flex flex-col gap-1 w-full px-3 py-5">
      ...
      {/* Mouse Icon */}
      <div className="w-16">
        <svg className="fill-white w-[18px]" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512">
